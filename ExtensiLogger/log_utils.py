...
def update_log_viewer(json_content):
    ...
    replace_data_in_viewer('log_library/collapsed_log_viewer.html', new_js_line)
    replace_data_in_viewer('log_library/graph_log_viewer.html', new_js_line)
    replace_data_in_viewer('log_library/flame_log_viewer.html', new_js_line)
